  ...
  return (
    <ModalBackdrop>
      <div
        ...
        className="bg-base-secondary dark:bg-base-secondary-dark min-w-[384px] p-6 rounded-xl flex flex-col gap-2 border border-tertiary dark:border-tertiary-dark"
      >
